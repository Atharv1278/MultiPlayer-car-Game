class Game {
  ...
  start() {
    ...
    var obstacle2Positions = [
      { x: width / 2 - 120, y: height - 3300, image: obstacle2Image },
      { x: width / 2 + 150, y: height - 2800, image: obstacle2Image },
      { x: width / 2 - 150, y: height - 5300, image: obstacle2Image },
     
      { x: width / 2 - 100, y: height - 5300, image: obstacle2Image },
